...
In an effort to refine Panoptic 3D, we compiled a custom dataset comprising over 24,000 samples. Leveraging the diverse scenes of the 3D Front dataset, we use BlenderProc \citep{Denninger2023} for randomly sampling camera poses and 2D rendering. Utilizing the C++ pipeline from \citet{dahnert2021panoptic}, we generate annotated 3D geometry within the respective camera frustum.